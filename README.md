...
- Python: `3.11`, `3.12` and `3.13` tested/compatible
- `python-miio==0.5.12`
- `click==8.1.8`
...
- Power on/off
- Auto, Silent, Fan and Manual modes
- Fan level
- Favorite level 1-14, used by Manual mode
- PM2.5
- PM10
- Temperature
- Humidity
...
Fixed Bright LED brightness for `zhimi.airp.vb4` while preserving Off and Dim behavior.


## Version 1.0.8

- Added automatic detection of the Python version used by `.venv`.
- Added support for Python 3.13 and future compatible Python versions.
- Added detection for both `lib` and `lib64` virtual-environment layouts.
- The plugin now verifies that the detected `site-packages` contains `miio`.
